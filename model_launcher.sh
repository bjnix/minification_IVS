...
DIR=`pwd`
rocks run host tile-0-0 command="DISPLAY=tile-0-0:0.0 ${DIR}/DGRAssimpSlave  0 1.2 0.2    0.4" &
rocks run host tile-0-1 command="DISPLAY=tile-0-1:0.0 ${DIR}/DGRAssimpSlave  0 1.2 0        0.2" &
rocks run host tile-0-2 command="DISPLAY=tile-0-2:0.0 ${DIR}/DGRAssimpSlave  0 1.2 -.2   0" &
rocks run host tile-0-3 command="DISPLAY=tile-0-3:0.0 ${DIR}/DGRAssimpSlave  0 1.2 -.4    -.2" &

rocks run host tile-0-4 command="DISPLAY=tile-0-4:0.0 ${DIR}/DGRAssimpSlave -1.2 0 0.2   0.4" &
rocks run host tile-0-5 command="DISPLAY=tile-0-5:0.0 ${DIR}/DGRAssimpSlave -1.2 0 0       0.2" &
rocks run host tile-0-6 command="DISPLAY=tile-0-6:0.0 ${DIR}/DGRAssimpSlave -1.2 0 -0.2  0" &
rocks run host tile-0-7 command="DISPLAY=tile-0-7:0.0 ${DIR}/DGRAssimpSlave -1.2 0 -0.4  -0.2" &
